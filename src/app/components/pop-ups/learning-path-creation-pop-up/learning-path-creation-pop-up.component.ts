...
export class LearningPathCreationPopUpComponent {
  ...
  /** ----------------------------------------------------------------
   *  FORM AUXILIAR USADO PELO TEMPLATE (para resolver erros no HTML)
   *  Mantém compatibilidade com seu fluxo baseado em `forms` (stepper).
   *  ---------------------------------------------------------------- */
  form = this.formBuilder.group({
    name: this.formBuilder.control<string>('', Validators.required),
    contentType: this.formBuilder.control<string>('text', Validators.required),
    description: this.formBuilder.control<string>(''),
    moduleId: this.formBuilder.control<string | null>(null),
    estimatedTime: this.formBuilder.control<number | null>(null),
    studentId: this.formBuilder.control<string | null>(null),
    shareWithOthers: this.formBuilder.control<boolean>(false),
    educationalContent: this.formBuilder.control<string>(''),
  });

  // Grupos usados pelo último passo do stepper, conforme seu fluxo original
  baseLastForm = {
  ...
  // Array de forms do stepper (mantido exatamente como estava)
  ...
  /** Adapta os botões do template para o fluxo atual */
  save() {
